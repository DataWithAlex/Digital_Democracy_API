...
class WebflowAPI:
    def __init__(self, api_key: str, collection_id: str, site_id: str):
        ...
        # Map jurisdiction to their corresponding ItemRefs
        self.jurisdiction_map = {
            'FL': '655288ef928edb128306745f',  # Replace with actual ItemRef for FL
            'US': '65810f6b889af86635a71b49'   # Replace with actual ItemRef for US
        }
